...
object PermissionUtils {
    ...
    fun getLocationRequest(context: Context): Task<LocationSettingsResponse> {
        // Create desired instance of location request
        ...
        // Check whether current settings are satisfied
        val locationSettingsClient = LocationServices.getSettingsClient(context)
        return locationSettingsClient.checkLocationSettings(locationSettingsRequest.build())
    }
