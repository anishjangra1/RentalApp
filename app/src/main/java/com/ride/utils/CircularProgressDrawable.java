...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    public CircularProgressDrawable(Context context, View animExcutor) {
     ...
     *
     * @param size of the loading progress.
     */
    ...
    public boolean isRunning() {
        ...
        final int animationSize = animators.size();
    ...
    public void start() {
        ...
        if (Float.floatToRawIntBits(mRing.getEndTrim()) != Float.floatToRawIntBits(mRing.getStartTrim())) {
            mFinishing = true;
    ...
    private static class Ring {
         ...
         */
        public void setArrowScale(float scale) {
            if (Float.floatToRawIntBits(scale) != Float.floatToRawIntBits(mArrowScale)) {
                mArrowScale = scale;
                invalidateSelf();
            }
        }
